import { FaTools, FaCodeBranch, FaNodeJs, FaReact, FaPhp, FaGithub, FaLaravel, FaDatabase, FaJava, FaPython, FaGitAlt, FaAngular, FaDocker, FaAws, FaFigma } from "react-icons/fa";
