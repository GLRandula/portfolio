...
//           <ContactLeft />
//           <div className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1f2744] to-[#1f2744] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne">
...
//                 <button
//                   onClick={handleSend}
//                   className="w-full h-12 bg-[#071929] rounded-lg text-base text-gray-400 tracking-wider uppercase hover:text-white duration-300 hover:border-[1px] hover:border-designColor border-transparent"
//                 >
//                   Send Message
//                 </button>
//               </div>
